...
/**
 * This is the item provider adapter for a {@link fr.irisa.dslCsv.Acquire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AcquireItemProvider extends FuncCallItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AcquireItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslCsvPackage.Literals.ACQUIRE__PATH);
			childrenFeatures.add(DslCsvPackage.Literals.ACQUIRE__SEP);
			childrenFeatures.add(DslCsvPackage.Literals.ACQUIRE__HAS_HEADER);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Acquire"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Acquire_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Acquire.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslCsvPackage.Literals.ACQUIRE__PATH,
		...
		newChildDescriptors.add
			(createChildParameter
				(DslCsvPackage.Literals.ACQUIRE__SEP,
				 DslCsvFactory.eINSTANCE.createExpression()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DslCsvPackage.Literals.ACQUIRE__HAS_HEADER,
				 DslCsvFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DslCsvPackage.Literals.ACQUIRE__PATH ||
			childFeature == DslCsvPackage.Literals.ACQUIRE__SEP ||
			childFeature == DslCsvPackage.Literals.ACQUIRE__HAS_HEADER;
