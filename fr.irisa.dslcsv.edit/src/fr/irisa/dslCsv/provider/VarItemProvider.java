...
/**
 * This is the item provider adapter for a {@link fr.irisa.dslCsv.Var} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarItemProvider extends BaseExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_var_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_var_feature", "_UI_Var_type"),
				 DslCsvPackage.Literals.VAR__VAR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Var)object).getVar();
